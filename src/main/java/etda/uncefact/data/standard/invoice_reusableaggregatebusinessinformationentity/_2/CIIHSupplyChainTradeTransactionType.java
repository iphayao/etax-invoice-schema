 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ApplicableCIIHSupplyChainTradeAgreement" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}CIIHSupplyChainTradeAgreementType"/&gt;
 *         &lt;element name="ApplicableCIIHSupplyChainTradeDelivery" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}CIIHSupplyChainTradeDeliveryType"/&gt;
 *         &lt;element name="ApplicableCIIHSupplyChainTradeSettlement" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}CIIHSupplyChainTradeSettlementType"/&gt;
 *         &lt;element name="IncludedCIILSupplyChainTradeLineItem" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}CIILSupplyChainTradeLineItemType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
