 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ShipToTradeParty" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}TradePartyType" minOccurs="0"/&gt;
 *         &lt;element name="ShipFromTradeParty" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}TradePartyType" minOccurs="0"/&gt;
 *         &lt;element name="ActualDeliverySupplyChainEvent" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:2}SupplyChainEventType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
