 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SellerCITradeParty" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CITradePartyType" minOccurs="0"/&gt;
 *         &lt;element name="BuyerCITradeParty" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CITradePartyType" minOccurs="0"/&gt;
 *         &lt;element name="ApplicableCITradeDeliveryTerms" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CITradeDeliveryTermsType" minOccurs="0"/&gt;
 *         &lt;element name="BuyerOrderReferencedCIReferencedDocument" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CIReferencedDocumentType" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalReferencedCIReferencedDocument" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CIReferencedDocumentType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
