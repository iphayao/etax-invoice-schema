 ...
 *         &lt;element name="ApplicableCITradeTax" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CITradeTaxType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedCITradeAllowanceCharge" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CITradeAllowanceChargeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedCITradePaymentTerms" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CITradePaymentTermsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecifiedCIIHTradeSettlementMonetarySummation" type="{urn:etda:uncefact:data:standard:Invoice_ReusableAggregateBusinessInformationEntity:1}CIIHTradeSettlementMonetarySummationType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
